<template>
  <div class="contain">
   <h3 style="line-height: 50px;text-align: center">轮播图</h3>
    <div class="box">
...
export default {
  ...
  data (){
    return {
        	list: [
						{ imgUrl: './static/images/t1.png' },
						{ imgUrl: './static/images/t2.png' },
						{ imgUrl: './static/images/t3.png' },
						{ imgUrl: './static/images/t4.png' },
						{ imgUrl: './static/images/t5.png' }
					],
