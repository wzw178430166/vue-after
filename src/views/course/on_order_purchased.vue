<template>
  ...
  <div id="tab-con">
    ...
    <div class="tab_itemst" id="tab_itemst_1" data-page='1'>232</div>
    <div class="tab_itemst" id="tab_itemst_2" data-page='2'>2424r</div>
   <div class="tab_itemst" id="tab_itemst_3" data-page='3' style="height: 100%;">
       <div id="main" style="height: 100%">333</div>
   </div>
